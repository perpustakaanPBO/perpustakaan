 ...
 */
public class MemberInfoCard extends javax.swing.JFrame {
...
//      jLabel_EmptyID.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MemberInfoCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MemberInfoCard().setVisible(true);
        });
    }
